  ...
  function criandoSelect() {
    setMudarElemento(
      <select
        ...
        id="opcao"
        onChange={pegarDado}
        className={styleUnidades.containerSelect}
      >
        <option disabled>Escolha uma unidade</option>
        <option value="1">Unidade Osasco</option>
        <option value="2">Unidade Capão Redondo</option>
        <option value="3">Unidade Santo Amaro</option>
        <option value="4">Unidade Santana</option>
        <option value="5">Unidade Itaquera</option>
      </select>
    );
  }
            ...
            return (
              <div className={styleUnidades.ContainerUnidades} key={dados.id}>
                <div className={styleUnidades.ContainerCards}>
                  ...
                  <h2 className={styleUnidades.funcionamento}>
                    {dados.funcionamento}
                  </h2>
                </div>

                <img
                  className={styleUnidades.imagemCards}
                  src={dados.imagem}
                  alt=""
                />
              </div>
