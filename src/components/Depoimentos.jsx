      ...
      <div className={styleDepoimentos.Container}>
        ...
        <span className={styleDepoimentos.ContainerCard}>
          <div className={styleDepoimentos.CardDepoimento}>
            <p className={styleDepoimentos.Informacoes}>
              "Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut
              recusandae ducimus eius alias doloremque. Illum odit natus, rem
              voluptatibus recusandae quibusdam pariatur, est nulla delectus
              neque tempora exercitationem quidem fugiat."
            </p>
