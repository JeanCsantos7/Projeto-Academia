  ...
  return (
    <>
      <div className={styleEscolhas.Container}>
        <h1 className={styleEscolhas.Titulo}>
          escolhas mais <br /> saudáveis
        </h1>
        <p className={styleEscolhas.Informações}>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quia,
          recusandae repudiandae. Dolorum error harum sint illum id, magnam modi
          hic aspernatur sit neque ullam, deleniti dolore accusantium dicta,
          assumenda aperiam.
        </p>
